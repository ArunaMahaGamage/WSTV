...
public class FragmentPageAdapter3 extends FragmentStatePagerAdapter {
    ViewPager viewPager;
    static String[] contentName = null, contentType = null, contentTime = null;
    Context c;
    Data d = new Data();

    public FragmentPageAdapter3(FragmentManager fm, String[] contentName, String[] contentType, String[] contentTime, ViewPager viewPager, Context c) {
        super(fm);
